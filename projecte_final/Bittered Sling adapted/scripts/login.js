...
$(window).on("load", async () => {
  ...
  try{
    ...
    showWarning("For this adapted version, just click login to enter!")
  }
...
const login = () => {
  ...
  // const user = users.fin    localStorage.setItem("logged", true);
  d(user => user.username === username && user.password === password);
